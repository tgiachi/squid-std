...
public class MailReaderTests
{
    ...
    public async Task Imap_FetchesNewMessage_AndMarksSeen()
    {
        ...
        await SendAsync(user, "imap-subject", withAttachment: true);
    ...
    public async Task Pop3_FetchesNewMessage_WithDelete()
    {
        ...
        await SendAsync(user, "pop-subject", withAttachment: false);
        var reader = new Pop3MailReader(new MailOptions
        {
